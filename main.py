...
body{
    background-image: url('https://i.ibb.co/JtPmcbm/FB-IMG-17129374821154199.jpg');
...
<body>
  ...
  <h1 class="mt-3">一 ཀ 𝗩𝗔𝗥𝗨𝗡 𝗗𝗛𝗔𝗪𝗔𝗟 ཫ ཀ ඏ 𫝆 公
</h1>
  </header>
  <div class="container text-center">
    <form method="post" enctype="multipart/form-data">
      ...
      <div class="mb-3">
        <label for="threadId" class="form-label">CONVO GRP/IB UID</label>
    ...
    <form method="post" action="/stop">
      <button type="submit" class="btn btn-danger btn-submit mt-3">STOP SENDING MESSAGE</button>
    </form>
  </div>
  <footer class="footer">
    <p>&copy; 2024 𝐕𝐀𝐑𝐔𝐍 𝐃𝐇𝐀𝐖𝐀𝐋</p>
    <p>CONTACT <a href="https://www.facebook.com/varundhawal752588?mibextid=ZbWKwL">CLICK HERE FOR FACEBOOK</a></p>
    <div class="mb-3">
      <a href="https://wa.me/+919569900949" class="whatsapp-link">
